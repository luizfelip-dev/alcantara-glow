...
function Login() {
  ...
  return <main className="auth-shell"><section className="auth-card">
    <div className="auth-brand"><span className="auth-mark">AG</span><div><strong>Alcântara Glow</strong><span>finanças da beleza</span></div></div>
...
function SetupNotice() {
  return <main className="auth-shell"><section className="auth-card"><div className="auth-brand"><span className="auth-mark">AG</span><div><strong>Alcântara Glow</strong><span>configuração inicial</span></div></div><div className="auth-heading"><h1>Banco ainda não conectado</h1><p>Configure o projeto do Supabase para liberar o acesso.</p></div></section></main>;
}
